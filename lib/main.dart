...
import 'package:mazik/bottom_controls.dart';
import 'package:mazik/songs.dart';
import 'package:mazik/theme.dart';
      ...
      child: new Scaffold(
          ...
          body: new Column(
            children: <Widget>[
              ...
              //Son title, artiste name, and controls
              new BottomControls()
...
class VisualizerPainter extends CustomPainter{
  ...
  void _renderWaves(Canvas canvas, Size size){
    final histogramLow = _createHistogramme(fft, 15, 2, ((fft.length) / 4).floor());
    final histogramHigh = _createHistogramme(fft, 15, (fft.length / 4).ceil(), (fft.length / 2).floor());
  ...
  List<int> _createHistogramme(List<int> samples, int bucketCount, [int start, int end]){
    if(start == end){
      return const [];
    }
    ...
    //Massage the data for visualisation
